    ...
    <div class="page">
        ...
        <div class="index_bd">
            ...
            <form id="search-form" method="post" action="/index/getMeetingNoticeList">
                ...
                <div class="i_col_r">
                    <div class="location"><b class="bg_i ico"></b>您的位置：<a href="/index/index.html">首页</a> </div>
                    <div class=" block2 sub_ct">
                        <ul id="list_sub" class="news_list">
                            <c:forEach items="${meetingNoticeList}" var="notice" varStatus="status">
                                <li id="li${status.index}">
                                <span class="n_t">
                                    <a href="/index/noticeDetail.html/${notice.id}" title="${notice.title}" target="_self">${status.index+1}、${notice.title}</a>
                                </span>
                                    <span class="date_t">${notice.updateTime}</span>
