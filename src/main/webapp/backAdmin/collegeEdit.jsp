...
<body>
	<form id="edit-form" action="/backAdmin/collegeEdit" method="post" onreset='formReset(this);' class="form form-horizontal">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-4">
				<input type="text" class="input-text size-S radius" id="name" name="name" placeholder="学院名称" value="${college.name}"/>
			</div>
			<div class="form-label col-xs-1 col-sm-1"></div>
		</div>
		<div class="row cl">
