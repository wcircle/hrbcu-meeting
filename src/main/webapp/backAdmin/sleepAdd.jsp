...
<body>
	<form id="add-form" action="/backAdmin/sleepAdd" method="post" onreset='formReset(this);' class="form form-horizontal">
		<div class="row cl">
			<div class="form-label col-xs-3 col-sm-3" style="font-size: 14px;"><span class="c-red">*</span>选择用户</div>
			<div class="formControls col-xs-6 col-sm-6">
				<select id="receiveId" name="receiveId" class="select-box radius">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-4">
				第<input type="number" class="input-text size-S radius" id="sleepOrder" name="sleepOrder" placeholder="住宿序号" />晚
			</div>
			<div class="form-label col-xs-1 col-sm-1"></div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-4">
				<input type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"
					   id="sleepDate" name="sleepDate" class="input-text Wdate size-S" style="width:180px;">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-6">
				<textarea id="address" name="address" class="textarea radius" style="font-size: 12px;" placeholder="住宿地点"></textarea>
			</div>
		</div>
		<div class="row cl">
